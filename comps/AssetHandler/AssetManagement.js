    ...
    <ScrollView>
      ...
      {selectedType && sections ? (
        <View style={styles.details}>
          ...
          <View
            style={{ padding: 5, backgroundColor: "#f2f2f2", borderRadius: 5 }}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              props.navigation.navigate("ServiceManagement", {
        ...
        <View style={styles.three}>
          ...
          >
            ...
            <MaterialCommunityIcons
              ...
              color={"#185a9d"}
              onPress={() =>
                setShowEditSection(true) || setName(selectedSection.name)
              }
              style={{ width: "15%" }}
            />
          ...
          >
            <View style={{ flexDirection: "row" }}>
              <Text style={styles.listNames}>Name</Text>
              <Text style={{ width: "70%", color: "#737373" }}>
                {selectedSection.name}
              </Text>
            </View>
            ...
            {selectedSection.location ? (
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={{ width: "30%", color: "#737373" }}>
          ...
          <View style={styles.two2}>
            <View style={{ flexDirection: "row" }}>
              <Text style={styles.cardTitle}>
                {selectedSection.name} {selectedType.name}s
              </Text>
            ...
            <View style={styles.modalView}>
              ...
              <View style={{ flexDirection: "row", marginBottom: "1%" }}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => setOpenSectionIcon(true)}
                >
                  <MaterialCommunityIcons
              ...
              <MaterialCommunityIcons
                name={
                  showAddType ? "plus-circle-outline" : "square-edit-outline"
                }
                size={30}
                color={"#609e9f"}
                onPress={() =>
                  handleType({ name, sectionIcon, assetIcon, showInMap, title })
                }
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <MaterialCommunityIcons
                name={
                  showAddSection ? "plus-circle-outline" : "square-edit-outline"
                }
                size={30}
                color={"#609e9f"}
                onPress={() =>
                  showAddSection
                    ? handleAdd("assetSections", {
                        assetType: selectedType.id,
                        name,
                        color,
                    ...
                    : handleEdit(
                        "assetSections",
                        { name, assetType: selectedType.id },
                        selectedSection.id
                      )
                }
                disabled={!name}
                  ...
                  {icons.map((i, index) => (
                    ...
                    >
                      <TouchableOpacity
                        onPress={() =>
                          openAssetIcon
                            ? setAssetIcon(i) || setOpenAssetIcon(false)
                            : setSectionIcon(i) || setOpenSectionIcon(false)
                        }
                      >
                        <MaterialCommunityIcons
                          name={i}
