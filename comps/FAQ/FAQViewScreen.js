                      ...
                      item.status == "approved" ? (
                        ...
                        // >
                          <View style={styles.two}>
                            <View style={{flexDirection:"row" , borderBottomWidth: 0.5 , borderBottomColor: "gray", marginTop:"2%"}}>
                          <Text style={{ fontSize: 32, color: "#901616"  }}>
                              Q.{" "}
                            </Text>
                            <Text
                              style={{ width: "90%", alignSelf: "center" , fontSize:18 , fontWeight:"bold" , color:"gray"}}
                            >
                              {item.question}
                            </Text>
                            </View>
                            ...
                            <Text
                              style={{ width: "90%", alignSelf: "center" , fontSize:18  , color:"black"}}
                            >
