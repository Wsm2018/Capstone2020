  ...
  return (
    <View style={styles.container}>
      ...
      <>
      {
        ...
        <TouchableOpacity  onPress={() => props.navigation.navigate("List",{tName:tName,section:s,startDate:startDate,endDate:endDate})} key={i} style={{alignItems:"center",borderRadius:50,height:20,width:200,margin:5, backgroundColor:'pink'}}>
          <Text >{s.name}</Text>
        </TouchableOpacity>
        ))}
        </>
