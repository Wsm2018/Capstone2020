  ...
  return (
    <View style={styles.container}>
      ...
      {finalAssets.length > 0? finalAssets.map((l,i)=>(
        <TouchableOpacity onPress={() => props.navigation.navigate("Details",{sName:sName,tName:tName,asset:l,startDateTime:startDateTime,endDateTime:endDateTime})} key={i} style={{alignItems:"center",borderRadius:50,height:20,width:200,margin:5, backgroundColor:'pink'}}>
          <Text >{l.code}</Text>
        </TouchableOpacity>
    ))
  :
