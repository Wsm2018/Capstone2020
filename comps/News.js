...
export default ({ item }) => {
  ...
  return editFlag ? (
    ...
    >
      ...
      >
          <Animatable.View animation="fadeIn" style={{alignItems:'flex-end', justifyContent:'flex-end'}}>
              <TouchableOpacity
                onPress={_pickImage}
                style={{
               //   marginLeft: "10%",
        ...
        >
          <Text style={{color:'#94A6AE', fontSize:18, fontWeight:'bold',paddingTop:'3%'}}>
            Start Date {'    '}
          </Text>
          <DatePicker
            style={{ width: "50%" }}
        ...
        >
          <Text style={{color:'#94A6AE', fontSize:18, fontWeight:'bold',paddingTop:'3%',paddingRight:'2%' }}>
            End Date {'     '}
          </Text>
